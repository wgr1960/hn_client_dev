...
var _services = __webpack_require__(76);

var newsService = _interopRequireWildcard(_services);

var _stateHelper = __webpack_require__(77);

var stateHelper = _interopRequireWildcard(_stateHelper);
...
function setPageHeader() {
    ...
    // Page icon setup
    var pageIconContainer = document.createElement('a');
    pageIconContainer.href = '/';
    ...
    pageIconContainer.appendChild(pageIcon);
    pageHeaderContainer.appendChild(pageIconContainer);
...
function addLimitButton() {
    if (!document.getElementsByClassName('limit-btn').length) {
        ...
        limitButtonContainer.className = 'limit-btn--container';
...
function addEventListener() {
    var limitBtn = document.getElementsByClassName('limit-btn');
    if (limitBtn.length) {
        limitBtn[0].addEventListener('click', showMoreStories, false);
    }
}
...
function getTopStories() {
    return newsService.news().fetchTopStories().then(function (response) {
...
function getLimitedStories() {
    ...
    for (var i = storyDisplayRange.startIndex; i < storyDisplayRange.endIndex; ++i) {
        topStoriesPromise.push(newsService.news().fetchStoryInfo(topStories[i]));
    }

    _promise2.default.all(topStoriesPromise).then(function (response) {
        var storyPromises = [];
        for (var i = 0; i < response.length; ++i) {
            storyPromises.push(response[i].json());
        }
        return _promise2.default.all(storyPromises);
...
function generateTopStories(topStory, index) {
    if (topStory.type === 'story') {
        ...
        topStoryTitle.innerHTML = '<a href="' + topStory.url + '">' + topStory.title + '</a> | ' + '<a class="comment-link" data-index=\'' + index + '\'>' + commentCount + ' comments</a>';

        topStoryRow.appendChild(topStoryIcon);
        topStoryRow.appendChild(topStoryTitle);
        var topStoriesContainer = document.getElementsByClassName('top-stories--container');

        if (topStoriesContainer.length) {
            topStoriesContainer[0].appendChild(topStoryRow);
        }
    }
}

// Execytes all functions
function init() {
    setPageHeader();
    populateTopStories();
}
...
// module
exports.push([module.i, "/*================\n    Variables\n==================*/\nbody {\n  background: #F3DFBF;\n  margin: 20px 5px;\n  font-family: \"Open Sans\", sans-serif; }\n  @media (min-width: 768px) {\n    body {\n      margin: 20px 10px; } }\n  @media (min-width: 992px) {\n    body {\n      margin: 20px 30px; } }\n\n.page-header--container {\n  height: 65px;\n  width: 100%;\n  z-index: 10;\n  position: fixed;\n  top: 0;\n  left: 0;\n  background: #F55555;\n  border-bottom: #FFA1A1 7px solid; }\n  .page-header--container .page-icon {\n    float: left;\n    margin: 5px;\n    height: 55px;\n    width: 55px; }\n    @media (min-width: 768px) {\n      .page-header--container .page-icon {\n        margin: 10px 5px; } }\n  .page-header--container .page-header {\n    font-family: \"Roboto\", sans-serif;\n    font-size: 20px;\n    font-weight: 200;\n    padding: 5px 35px;\n    color: white; }\n    @media (min-width: 768px) {\n      .page-header--container .page-header {\n        font-size: 24px; } }\n  @media (min-width: 768px) {\n    .page-header--container {\n      height: 75px; } }\n\n#pageLoader {\n  margin-top: 125px;\n  color: #7098E2;\n  font-size: 20px;\n  text-align: center; }\n\n.top-stories--container {\n  margin-top: 95px; }\n  .top-stories--container .story--container {\n    display: flex;\n    flex-direction: row;\n    flex-wrap: wrap;\n    border-radius: 3px;\n    position: relative;\n    cursor: default;\n    box-shadow: 0 6px 10px 0 rgba(104, 104, 104, 0.14), 0 1px 18px 0 rgba(104, 104, 104, 0.12), 0 3px 5px -1px rgba(104, 104, 104, 0.3);\n    background-color: #F7F7F7;\n    padding: 1px 15px;\n    margin: 7px 15px;\n    -webkit-transition: all ease-out 0.2s;\n    -moz-transition: all ease-out 0.2s;\n    -ms-transition: all ease-out 0.2s;\n    -o-transition: all ease-out 0.2s;\n    transition: all ease-out 0.2s;\n    -webkit-animation: fade-in 2s;\n    -moz-animation: fade-in 2s;\n    -ms-animation: fade-in 2s;\n    -o-animation: fade-in 2s;\n    animation: fade-in 2s; }\n\n@-webkit-keyframes fade-in {\n  from {\n    opacity: 0; }\n  to {\n    opacity: 1; } }\n\n@-moz-keyframes fade-in {\n  from {\n    opacity: 0; }\n  to {\n    opacity: 1; } }\n\n@-o-keyframes fade-in {\n  from {\n    opacity: 0; }\n  to {\n    opacity: 1; } }\n\n@-ms-keyframes fade-in {\n  .top-stories--container .story--container from {\n    opacity: 0; }\n  .top-stories--container .story--container to {\n    opacity: 1; } }\n\n@keyframes fade-in {\n  from {\n    opacity: 0; }\n  to {\n    opacity: 1; } }\n    .top-stories--container .story--container:hover {\n      -moz-transform: scale(1.01);\n      -webkit-transform: scale(1.01);\n      transform: scale(1.01); }\n    .top-stories--container .story--container .top-story--icon {\n      float: left;\n      margin: 20px 5px;\n      margin-right: 15px;\n      height: 20px;\n      width: 20px; }\n    .top-stories--container .story--container .top-story--title a {\n      cursor: pointer;\n      text-decoration: none;\n      font-weight: 400; }\n      .top-stories--container .story--container .top-story--title a:first-child {\n        color: #5178C2;\n        margin-right: 5px; }\n      .top-stories--container .story--container .top-story--title a:nth-child(2) {\n        color: #7098E2;\n        margin-left: 5px; }\n    @media (min-width: 768px) {\n      .top-stories--container .story--container {\n        margin: 7px 35px; } }\n    @media (min-width: 992px) {\n      .top-stories--container .story--container {\n        margin: 7px 75px; } }\n\n.limit-btn--container {\n  margin: 25px 15px; }\n  .limit-btn--container .limit-btn {\n    padding: 8px 45px;\n    border: 0;\n    background: #F87575;\n    color: white;\n    cursor: pointer;\n    font-size: 14px;\n    box-shadow: 0 6px 10px 0 rgba(104, 104, 104, 0.14), 0 1px 18px 0 rgba(104, 104, 104, 0.12), 0 3px 5px -1px rgba(104, 104, 104, 0.3); }\n    .limit-btn--container .limit-btn:hover {\n      background: #7098E2; }\n  @media (min-width: 768px) {\n    .limit-btn--container {\n      margin: 25px 35px; } }\n  @media (min-width: 992px) {\n    .limit-btn--container {\n      margin: 25px 75px; } }\n", ""]);
...
function news() {
    ...
    var dataURL = 'https://hacker-news.firebaseio.com';
    var version = 'v0';
    var header = {
    ...
    function fetchStoryInfo(topStory) {
        var storyURL = dataURL.concat('/', version, '/item/', topStory, '.json?print=pretty');
        return fetch(storyURL, header);
    }
...
function stateChanger() {
    ...
    function addStateListener(domElement, attribute) {
        domElement.addEventListener('click', function (e) {
            if (e.target != event.currentTarget) {
                e.preventDefault();

                var data = e.target.getAttribute(attribute);
                url = data + '.html';
    ...
    return {
        addStateListener: addEventListener
    };
}
