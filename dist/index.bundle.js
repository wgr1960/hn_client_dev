...
var newsService = __webpack_require__(76);
var stateHelper = __webpack_require__(77);
...
function getLimitedStories() {
    ...
    for (var i = storyDisplayRange.startIndex; i < storyDisplayRange.endIndex; ++i) {
        topStoriesPromise.push(newsService.fetchStoryInfo(topStories[i]));
    }
...
module.exports = {
    ...
    fetchStoryInfo: function fetchStoryInfo(topStory) {
...
module.exports = {
    addStateListener: function addStateListener(domElement, attribute) {
